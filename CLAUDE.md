...
| UI | **Compose Multiplatform + tokens portados de LumeUIKit** — el *lenguaje* visual se comparte; el código, no | ADR-0002 §UI. Un componente reutilizable vive en el módulo `designkit` de este repo, jamás inline en una pantalla. Cero estilos hardcodeados. |
